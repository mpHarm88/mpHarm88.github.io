...
layout: post
title: 🔎 Exploring Black Box Classification Models using Google Analytics Data
...
<h3 align="center">Make real time predictions using the better model [here](https://cust-pred.herokuapp.com). </h4>

<h6 align="center>It might take a minute to load</h6>
